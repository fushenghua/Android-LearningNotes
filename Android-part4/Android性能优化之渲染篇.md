...
![](/img/android_performance_course_drop_frame.png)
...
![](/img/android_performance_course_render_problems.jpg)
...
![](/img/gpu_cpu_rasterization-1.png)
...
![](/img/overdraw_hidden_view-1.png)
...
![](/img/overdraw_options_view-1.png)
...
![](/img/android_perf_course_overdraw_compare.png)
...
![](/img/overdraw_reduce_cpu_gpu-1.png)
...
![](/img/android_perf_course_displaylist_execute.png)

然而如果你修改了View中的某些可见组件的内容，那么之前的DisplayList就无法继续使用了，我们需要重新创建一个DisplayList并重新执行渲染指令更新到屏幕上。

![](/img/android_perf_course_displaylist_invalidation.png)
...
![](/img/android_perf_course_displaylist_kick_off.png)
...
![](/img/android_perf_course_hierarchy_1.png)

![](/img/android_perf_course_hierarchy_2.png)

下图显示了使用2种不同的写法，在Hierarchy Viewer上呈现出来的性能测试差异：

![](/img/android_perf_course_hierarchy_3.png)

### 13)Optimizing Your Layout

下图举例演示了如何优化ListItem的布局，通过RelativeLayout替代旧方案中的嵌套LinearLayout来优化布局。

![](/img/android_perf_course_hierarchy_4.png)
