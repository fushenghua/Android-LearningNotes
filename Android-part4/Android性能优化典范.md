...
![](/img/draw_per_16ms.png)

如果你的某个操作花费时间是24ms，系统在得到VSYNC信号的时候就无法进行正常渲染，这样就发生了丢帧现象。那么用户在32ms内看到的会是同一帧画面。

![](/img/vsync_over_draw.png)
...
![](/img/vsync_gpu_hardware_not_sync2.png)
...
![](/img/tools_gpu_profile_rendering.png)

选择了这样以后，我们可以在手机画面上看到丰富的GPU绘制图形信息，分别关于StatusBar，NavBar，激活的程序Activity区域的GPU Rending信息。

![](/img/tools_gpu_profile_rendering_graphic_activity.png)

随着界面的刷新，界面上会滚动显示垂直的柱状图来表示每帧画面所需要渲染的时间，柱状图越高表示花费的渲染时间越长。

![](/img/tools_gpu_rendering_bar.png)

中间有一根绿色的横线，代表16ms，我们需要确保每一帧花费的总时间都低于这条横线，这样才能够避免出现卡顿的问题。

![](/img/tools_gpu_profile_three_color.png)
...
![](/img/overdraw_reduce_cpu_gpu.png)
...
![](/img/memory_mode_generation-2.png)

除了速度差异之外，执行GC操作的时候，所有线程的任何操作都会需要暂停，等待GC操作完成之后，其他操作才能够继续运行。

![](/img/gc_event_thread_stop-1.png)
...
![](/img/memory_leak_profile_method.png)
...
![](/img/memory_leak_track_method.png)
...
![](/img/memory_monitor_overview-1.png)

![](/img/memory_monitor_free_allocation-2.png)

![](/img/memory_monitor_gc_event-2.png)
...
![](/img/battery_usages_settings.png)
...
![](/img/alarmmanager_inexact_wakelock.png)
