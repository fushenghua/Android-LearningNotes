...
![](/img/draw_per_16ms-1.png)

如果你的某个操作花费时间是24ms，系统在得到VSYNC信号的时候就无法进行正常渲染，这样就发生了丢帧现象。那么用户在32ms内看到的会是同一帧画面。

![](/img/vsync_over_draw-1.png)
...
![](/img/overdraw_hidden_view-2.png)
...
![](/img/overdraw_options_view-2.png)
...
![](/img/vsync_gpu_hardware_not_sync2-1.png)
...
![](/img/tools_gpu_profile_rendering-1.png)

选择了这样以后，我们可以在手机画面上看到丰富的GPU绘制图形信息，分别关于StatusBar，NavBar，激活的程序Activity区域的GPU Rending信息。

![](/img/tools_gpu_profile_rendering_graphic_activity-1.png)

随着界面的刷新，界面上会滚动显示垂直的柱状图来表示每帧画面所需要渲染的时间，柱状图越高表示花费的渲染时间越长。

![](/img/tools_gpu_rendering_bar-1.png)

中间有一根绿色的横线，代表16ms，我们需要确保每一帧花费的总时间都低于这条横线，这样才能够避免出现卡顿的问题。

![](/img/tools_gpu_profile_three_color-1.png)
...
![](/img/gpu_cpu_rasterization-2.png)
...
![](/img/overdraw_reduce_cpu_gpu-2.png)
...
![](/img/memory_mode_generation-3.png)

除了速度差异之外，执行GC操作的时候，所有线程的任何操作都会需要暂停，等待GC操作完成之后，其他操作才能够继续运行。

![](/img/gc_event_thread_stop-2.png)
...
![](/img/memory_leak_profile_method-1.png)
...
![](/img/memory_leak_track_method-1.png)
...
![](/img/memory_monitor_overview-2.png)

![](/img/memory_monitor_free_allocation-3.png)

![](/img/memory_monitor_gc_event-3.png)
...
![](/img/battery_usages_settings-1.png)
...
![](/img/alarmmanager_inexact_wakelock-1.png)
